...
import subprocess, threading, string,codecs, requests, ctypes, urllib, urllib2, cookielib,urllib3
...
cl = LINETCR.LINE()
cl.login(token="EsPsBlFZyR8AGBKBxG21.8nezDhK7HGW9hVtLK4qvGq.RrO+dWxU6wkWNYG7vBS915+EfBzyyrmcn5mPLbSKQyQ=")
cl.loginResult()

ki = LINETCR.LINE()
ki.login(token="EsVm7VamKloDXTIPZBp5.u0ANNHNbz+8A9tkOyStObq./VXPFKO2QqHw4k3znrgDXm/vkzAVXvSzjFQVjEk7l5o=")
ki.loginResult()

kk = LINETCR.LINE()
kk.login(token="EsYpUtHLJ6r0iX6uTC94.wOkmirNWe41AVCDdjgw/za.iErveZoqxGunh9Qc/V+MVunMrJJonnaNwzI8v6HS3Ew=")
kk.loginResult()

kc = LINETCR.LINE()
kc.login(token="EsoOYEdBUwHhJRfUMSD6.8b9UL15I+4kH7tSG4DI/LG.FJPUQgWd0GDENPrH2Bjgikd3FBTZS/onLoPCkexGteQ=")
kc.loginResult()
...
ka = LINETCR.LINE()
ka.login(token="EssVtg9RrYvxmqeXQJJd.5ws3BZPRgZdFiDAuWEqM+q.UpjxZqwiJ5QH5pmUCYBpXSJ/vU27R6pftocze/jbLkA=")
ka.loginResult()

kb = LINETCR.LINE()
kb.login(token="Esa8EnfS3vKHWP7sGxke.AKJjgcQRejNwIdH96qxmZG.yD+ySPayum+5goJSD1W+0M7aaVfPXXRjUJOzMyeWWA4=")
kb.loginResult()

ko = LINETCR.LINE()
ko.login(token="EsuYv6N1HUwcspnHyiT5.RdiQlB/fD7H0LkdM1ueLjq.BwtYD/fbdqB+eAuRAk8pAUUXiFbdn3jv+/YMIk46eZQ=")
ko.loginResult()

ke = LINETCR.LINE()
ke.login(token="EsuYv6N1HUwcspnHyiT5.RdiQlB/fD7H0LkdM1ueLjq.BwtYD/fbdqB+eAuRAk8pAUUXiFbdn3jv+/YMIk46eZQ=")
ke.loginResult()

ku = LINETCR.LINE()
ku.login(token="Es3ZoqGBqWz0aEXIJY1d.AiuDauRno6zp87MMtt5NRq.rXFoqi/LS2srihfTZdy2zag6ywTU/IaCBFhfy44K3WE=")
ku.loginResult()

k1 = LINETCR.LINE()
k1.login(token="EsKVcCmEPUoTwk06Q5k1.RNY0mD5hMgMbcfE1tEAyWq.PEdiW3Du2aUU3y+b6YwgJ5iuOFyei+BbCsxN1/+nE8w=")
k1.loginResult()
                        ...
                        if op.param1 in cctv['point']:
                            ...
                            if Name in cctv['sidermem'][op.param1]:
                                ...
                                if " " in Name:
                                    nick = Name.split(' ')
                                    if len(nick) == 2:
                                        random.choice(KAC).sendText(op.param1, "Haii kak" + "☞ " + nick[0] + " ☜" + "\nNgintip Aja Niih. . .\nChat Kek Idiih (p′︵‵。) 🤗 \nJam :" + datetime.today().strftime('%H:%M:%S'))
                                    else:
                                        random.choice(KAC).sendText(op.param1,"Haii kak" + "☞ " + nick[0] + " ☜" + "\nSini kak \nIkut chat yuk (p′︵‵。) 🤗 \nJam :" + datetime.today().strftime('%H:%M:%S'))
                                else:
                                    random.choice(KAC).sendText(op.param1,"Haii kak" + "☞ " + nick[0] + " ☜" + "\nSini kak \nIkut chat yuk (p′︵‵。) 🤗 \nJam :" + datetime.today().strftime('%H:%M:%S'))
                ...
                if op.param1 in wait['pname']:
                    ...
                    try:
                       random.choice(KAC).updateGroup(G)
                        ...
                        try:
                           random.choice(KAC).sendText(op.param1,random.choice(KAC).getContact(op.param2).displayName + "Kak jgn Tukar Nama group \nMaaf kak Aku kick kamu\nKak bukan admin. \nOwner juga bukan p′︵‵。) 🤗 \nJam :" + datetime.today().strftime('%H:%M:%S'))
...
#--------------------------------
        ...
        if op.type == 26:
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["detectMention3"] == True:
                    ...
                    balas = ["Woii kak"  + cName + ", Dasar Jones Ngetag Mulu!"]
                    ret_ = random.choice(balas)
                    name = re.finydall(r'@(\w+)', msg.text)
                    mention = contentMetadata['MENTION']
        ...
        if op.type == 26:
            ...
            if msg.text in ["Bot on"]:
                wait["Bot"] = True
                cl.sendText(msg.to,"Bot Sudah On Kembal \nJam :" + datetime.today().strftime('%H:%M:%S'))
        if op.type == 26:
          if wait["Bot"] == True:
            msg = op.message
            ...
            if msg.contentType == 13:
                if wait['invite'] == True:
                    ...
                    for s in groups.members:
                        if _name in s.displayName:
                            cl.sendText(msg.to, _name + " Berada DiGrup")
                        else:
            ...
            if msg.contentType == 13:
              ...
              if msg.from_ in admin:
                ...
                if msg.to in cctv['point']:
                    ...
                    cl.sendText(msg.to,"Blum di on kak")
...
#-----------------------------------------------
      ...
      #-------------Fungsi Banned Send Contact Finish------------------#
              ...
              cl.sendMessage(msg)
              cl.sendText(msg.to,"======================")
              cl.sendText(msg.to,"Itu Creator Kami Yang Nakal 😜")
